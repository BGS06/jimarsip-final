          ...
          <Link href={item.href} key={i} className="bg-white p-5 md:p-6 rounded-2xl md:rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-blue-200 group cursor-pointer">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-[11px] md:text-xs font-bold text-gray-400 mb-1 group-hover:text-blue-600 transition-colors">{item.title}</p>
            ...
            <div className="flex items-center justify-between mt-5 md:mt-6 pt-3 md:pt-4 border-t border-gray-50 group-hover:border-blue-100 transition-colors">
              <p className="text-[10px] md:text-[11px] text-gray-400 font-semibold">{item.sub}</p>
